...
quotasStr.IPs="IP(s)";
quotasStr.Active="Active";
quotasStr.Limits="Limits";
quotasStr.Totals="(Total/Down/Up)";
quotasStr.OthersOne="Others (Individual)";
quotasStr.OthersAll="Others (Combined)";
quotasStr.Only="Only";
quotasStr.AllExcept="All Times Except";
quotasStr.AddError="Could not add quota.";
quotasStr.LD1s="st";
quotasStr.LD2s="nd";
quotasStr.LD3s="rd";
quotasStr.Digs="th";
quotasStr.IPError="You must specify at least one valid IP or IP range";
quotasStr.AllUnlimitedError="Upload, download and combined bandwidth limits cannot all be unlimited";
quotasStr.DuplicateRange="Duplicate IP/Time Range -- only one quota per IP at a given time is allowed";
